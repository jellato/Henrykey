                        ...
                        <div class="project-info">
                          ...
                          <div class="project-tech-used">
                            <img 
                              ...
                              :key="tech.name" 
                              :src="require('../assets/img/technologies/' + tech.icon)" 
                              :alt="tech.name" 
                          ...
                          <img :src="require('../assets/img/technologies/' + project.technologyImg)" :alt="project.category" class="project-tag">
                        </div>
                        <div class="project-image-composition">
                          <img src="../assets/img/projects/laptop.png" alt="laptop" class="laptop">
                          <div 
                            class="project-desktop-img"
                            >
                            <img :src="require('../assets/img/projects/' + project.projectImage)" :alt="project.name" class="project-img-desktop">
                          </div>
                          <img src="../assets/img/projects/phone.png" alt="phone" class="phone">
                          <div 
                            class="project-mobile-img" 
                            >
                            <img :src="require('../assets/img/projects/' + project.projectMobileImage)" :alt="project.name" class="project-img-mobile">
                          </div>
                        </div>
                      </a>
                    </div>
                  </div>
                  <img src="../assets/img/thats-all.png" alt="that's all folks" class="thats-all-img">
           </div> 
        </section>
</template>
